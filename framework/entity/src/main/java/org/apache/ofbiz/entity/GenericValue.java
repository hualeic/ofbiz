...
public class GenericValue extends GenericEntity {
	...
	public static GenericValue create(Delegator delegator, ModelEntity modelEntity,
	 ...
	 * @return List of GenericValue instances as specified in the relation definition
	 */
	public List<GenericValue> getRelatedMulti(String relationNameOne, String relationNameTwo)
			throws GenericEntityException {
